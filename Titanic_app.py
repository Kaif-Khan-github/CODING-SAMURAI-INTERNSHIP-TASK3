...
st.markdown("Fill in the passenger details below to predict their survival on the Titanic.")
...
def preprocess_input(pclass, sex, age, sibsp, parch, fare, embarked):
    """Transforms user inputs into model-ready DataFrame."""
    df = pd.DataFrame({
        'pclass': [pclass],
        ...
        # 'embarked_C' is implied if both above are 0
    })
    return df
